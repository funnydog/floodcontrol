...
{
public:
	explicit ShaderUniform(int value) : mLocation(value) {}
...
public:
	...
	bool attachString(Type type, const std::string &source) const noexcept;
	bool attachFile(Type type, const std::filesystem::path &filename) const noexcept;
